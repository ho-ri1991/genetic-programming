...
using TypeTuple = std::tuple<int, bool>;
...
int main() {
    ...
    tree::TreeIO<maxSubroutnieArgNum, TypeTuple> treeIO;
    genetic_operations::DefaultRandomNodeGenerator<rnd, TypeTuple> randomNodeGenerator(random_gens);
